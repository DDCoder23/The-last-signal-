...
Date : Thu Jul 16 06:53:50 UTC 2026
...
Run started:2026-07-16 06:53:51.202279+00:00
...
[1m  Found and scanned 110 packages[0m
  Timestamp [1m2026-07-16 06:53:55[0m
...
└──────────────────┘
   ...
   ❯❯❱ yaml.github-actions.security.run-shell-injection.run-shell-injection
          ...
          Details: https://sg.run/pkzk                                                                        
           ...
           78┆ run: |
           79┆
           80┆   git add reports database dashboard README.md
           81┆   git commit -m "auto update du jeu"
           82┆   for i in 1 2 3
           83┆   do
           84┆     git pull --rebase origin ${{ inputs.branch }}
           85┆
           86┆     if git push origin ${{ inputs.branch }}
           87┆     then
             [hid 10 additional lines, adjust with --max-lines-per-finding] 
...
[90m6:54AM[0m [32mINF[0m [1m936 commits scanned.[0m
[90m6:54AM[0m [32mINF[0m [1mscanned ~21742001 bytes (21.74 MB) in 823ms[0m
[90m6:54AM[0m [32mINF[0m [1mno leaks found[0m
...
## Cargo Deny
2026-07-16 06:54:06 [[31mERROR[0m] the directory /home/runner/work/The-last-signal-/The-last-signal- doesn't contain a Cargo.toml file[0m
