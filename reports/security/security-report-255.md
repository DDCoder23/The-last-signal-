...
Date : Thu Jul 16 06:51:37 UTC 2026
...
Run started:2026-07-16 06:51:38.886164+00:00
...
[1m  Found and scanned 110 packages[0m
  Timestamp [1m2026-07-16 06:51:44[0m
...
[0m[0m[1m[32m      Loaded[0m 1160 security advisories (from /home/runner/.cargo/advisory-db)
...
│ Scan Status │
└─────────────┘
  Scanning 161 files tracked by git with 1074 Code rules:
                                                                                                                        
  Language      Rules   Files          Origin      Rules                                                                
 ─────────────────────────────        ───────────────────                                                               
  <multilang>      60     161          Community    1074                                                                
  python          243      34                                                                                           
  yaml             36      11                                                                                           
  json              4       7                                                                                           
  rust              4       1                                                                                           
...
└──────────────────┘
    ...
    .github/actions/commit-reports/action.yml
   ❯❯❱ yaml.github-actions.security.run-shell-injection.run-shell-injection
          ...
          Details: https://sg.run/pkzk                                                                        
           ...
           45┆   git fetch origin
           46┆
           47┆   if git show-ref --verify --quiet refs/remotes/origin/${{ inputs.branch }}
           48┆   then
           49┆     git checkout ${{ inputs.branch }}
           50┆     git pull origin ${{ inputs.branch }}
           51┆   else
           52┆     git checkout --orphan ${{ inputs.branch }}
             [hid 3 additional lines, adjust with --max-lines-per-finding] 
           57┆ run: |
           58┆
           59┆   mkdir -p reports/${{ inputs.report-type }}
           60┆   mkdir -p database/${{ inputs.report-type }}
           61┆   mkdir -p dashboard/${{ inputs.report-type }}
           62┆
           63┆   if [ -d /tmp/ci-backup/reports ]; then
           64┆     cp -r /tmp/ci-backup/reports/. reports/${{ inputs.report-type }}/
           65┆   fi
           66┆
             [hid 8 additional lines, adjust with --max-lines-per-finding] 
           94┆ run: |
           95┆
           96┆   git add reports database dashboard README.md
           97┆   git commit -m "auto update du jeu"
           98┆   for i in 1 2 3
           99┆   do
          100┆     git pull --rebase origin ${{ inputs.branch }}
          101┆
          102┆     if git push origin ${{ inputs.branch }}
          103┆     then
    ...
    ❯❱ yaml.github-actions.security.github-actions-mutable-action-tag.github-actions-mutable-action-tag
          ...
          Details: https://sg.run/2LgAL                                                                       
           ...
           68┆ uses: actions-rust-lang/setup-rust-toolchain@v1
            ⋮┆----------------------------------------
           96┆ uses: lycheeverse/lychee-action@v2
            ⋮┆----------------------------------------
    ...
    ❯❱ yaml.github-actions.security.github-actions-mutable-action-tag.github-actions-mutable-action-tag
          ...
          Details: https://sg.run/2LgAL                                                                       
           ...
           71┆ uses: dtolnay/rust-toolchain@stable
            ⋮┆----------------------------------------
          276┆ uses: github/codeql-action/init@v3
            ⋮┆----------------------------------------
          281┆ uses: github/codeql-action/autobuild@v3
            ⋮┆----------------------------------------
          284┆ uses: github/codeql-action/analyze@v3
            ⋮┆----------------------------------------
    ...
    Ancien/localisation.py
     ❱ python.lang.security.audit.insecure-transport.requests.request-with-http.request-with-http
          ...
          Details: https://sg.run/W8J4                                                                    
            ...
            8┆ reponse = requests.get(url, timeout=5)
...
Ran 345 rules on 161 files: 38 findings.
...
[90m6:51AM[0m [32mINF[0m [1m931 commits scanned.[0m
[90m6:51AM[0m [32mINF[0m [1mscanned ~21734336 bytes (21.73 MB) in 1.04s[0m
[90m6:51AM[0m [32mINF[0m [1mno leaks found[0m
...
## Cargo Deny
2026-07-16 06:51:56 [[31mERROR[0m] the directory /home/runner/work/The-last-signal-/The-last-signal- doesn't contain a Cargo.toml file[0m

## Outdated Python packages
Package                                  Version Latest Type
---------------------------------------- ------- ------ -----
boltons                                  21.0.0  26.0.0 wheel
...
opentelemetry-api                        1.37.0  1.43.0 wheel
opentelemetry-exporter-otlp-proto-common 1.37.0  1.43.0 wheel
opentelemetry-exporter-otlp-proto-http   1.37.0  1.43.0 wheel
opentelemetry-proto                      1.37.0  1.43.0 wheel
opentelemetry-sdk                        1.37.0  1.43.0 wheel
peewee                                   3.19.0  4.2.3  wheel
