...
Date : Wed Sep  9 19:54:33 UTC 2026
...
error[E0308]: mismatched types
   --> src/gameplay/table_de_conversion.rs:194:34
    |
194 |                 1 => Self::l1_l2(stuff, nb as usize, &mut stats)?,
    |                      ----------- ^^^^^ expected `&mut HashMap<String, Livre>`, found `&mut HashMap<String, Objet>`
    |                      |
    |                      arguments to this function are incorrect
    |
    = note: expected mutable reference `&mut HashMap<_, Livre>`
               found mutable reference `&mut HashMap<_, Objet>`
note: associated function defined here
   --> src/gameplay/table_de_conversion.rs:206:8
    |
206 |     fn l1_l2(
    |        ^^^^^
207 |         stuff: &mut HashMap<String, Livre>,
    |         ----------------------------------

error[E0308]: mismatched types
   --> src/gameplay/table_de_conversion.rs:195:34
    |
195 |                 2 => Self::l2_l3(stuff, nb as usize, &mut stats)?,
    |                      ----------- ^^^^^ expected `&mut HashMap<String, Livre>`, found `&mut HashMap<String, Objet>`
    |                      |
    |                      arguments to this function are incorrect
    |
    = note: expected mutable reference `&mut HashMap<_, Livre>`
               found mutable reference `&mut HashMap<_, Objet>`
note: associated function defined here
   --> src/gameplay/table_de_conversion.rs:280:8
    |
280 |     fn l2_l3(
    |        ^^^^^
281 |         stuff: &mut HashMap<String, Livre>,
    |         ----------------------------------

error[E0308]: mismatched types
   --> src/gameplay/table_de_conversion.rs:196:34
    |
196 |                 3 => Self::l3_l4(stuff, nb as usize, &mut stats)?,
    |                      ----------- ^^^^^ expected `&mut HashMap<String, Livre>`, found `&mut HashMap<String, Objet>`
    |                      |
    |                      arguments to this function are incorrect
    |
    = note: expected mutable reference `&mut HashMap<_, Livre>`
               found mutable reference `&mut HashMap<_, Objet>`
note: associated function defined here
   --> src/gameplay/table_de_conversion.rs:363:8
    |
363 |     fn l3_l4(
    |        ^^^^^
364 |         stuff: &mut HashMap<String, Livre>,
    |         ----------------------------------

error[E0308]: mismatched types
   --> src/gameplay/table_de_conversion.rs:197:34
    |
197 |                 4 => Self::l4_l5(stuff, nb as usize, &mut stats)?,
    |                      ----------- ^^^^^ expected `&mut HashMap<String, Livre>`, found `&mut HashMap<String, Objet>`
    |                      |
    |                      arguments to this function are incorrect
    |
    = note: expected mutable reference `&mut HashMap<_, Livre>`
               found mutable reference `&mut HashMap<_, Objet>`
note: associated function defined here
   --> src/gameplay/table_de_conversion.rs:447:8
    |
447 |     fn l4_l5(
    |        ^^^^^
448 |         stuff: &mut HashMap<String, Livre>,
    |         ----------------------------------

error[E0308]: mismatched types
   --> src/gameplay/table_de_conversion.rs:198:34
    |
198 |                 5 => Self::l5_l6(stuff, nb as usize, &mut stats)?,
    |                      ----------- ^^^^^ expected `&mut HashMap<String, Livre>`, found `&mut HashMap<String, Objet>`
    |                      |
    |                      arguments to this function are incorrect
    |
    = note: expected mutable reference `&mut HashMap<_, Livre>`
               found mutable reference `&mut HashMap<_, Objet>`
note: associated function defined here
   --> src/gameplay/table_de_conversion.rs:537:8
    |
537 |     fn l5_l6(
    |        ^^^^^
538 |         stuff: &mut HashMap<String, Livre>,
    |         ----------------------------------
...
error[E0599]: no method named `retirer` found for mutable reference `&mut Livre` in the current scope
   --> src/gameplay/table_de_conversion.rs:260:28
    |
260 |                     livre1.retirer(1);
    |                            ^^^^^^^ method not found in `&mut Livre`
    |
    = help: items from traits can only be used if the trait is in scope
...
error[E0599]: no method named `ajouter` found for mutable reference `&mut Livre` in the current scope
...
error: could not compile `the-last-signal-server` (lib) due to 25 previous errors; 2 warnings emitted
warning: build failed, waiting for other jobs to finish...
warning: `the-last-signal-server` (lib test) generated 2 warnings (2 duplicates)
error: could not compile `the-last-signal-server` (lib test) due to 25 previous errors; 2 warnings emitted
