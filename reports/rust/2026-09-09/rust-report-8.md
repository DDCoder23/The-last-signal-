...
Date : Wed Sep  9 19:30:12 UTC 2026
...
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/gameplay/table_de_conversion.rs:633:
         Ok(())
     }
 }
-
...
error[E0432]: unresolved import `crate::objets`
 --> src/gameplay/table_de_conversion.rs:4:12
  |
4 | use crate::objets::{Livre, Objet};
  |            ^^^^^^ unresolved import
  |
help: a similar path exists
  |
4 | use crate::gameplay::objets::{Livre, Objet};
  |            ++++++++++

error[E0425]: cannot find function `thread_rng` in crate `rand`
   --> src/gameplay/table_de_conversion.rs:211:29
    |
211 |         let mut rng = rand::thread_rng();
    |                             ^^^^^^^^^^ not found in `rand`

error[E0425]: cannot find function `thread_rng` in crate `rand`
   --> src/gameplay/table_de_conversion.rs:285:29
    |
285 |         let mut rng = rand::thread_rng();
    |                             ^^^^^^^^^^ not found in `rand`

error[E0425]: cannot find function `thread_rng` in crate `rand`
   --> src/gameplay/table_de_conversion.rs:368:29
    |
368 |         let mut rng = rand::thread_rng();
    |                             ^^^^^^^^^^ not found in `rand`

error[E0425]: cannot find function `thread_rng` in crate `rand`
   --> src/gameplay/table_de_conversion.rs:453:29
    |
453 |         let mut rng = rand::thread_rng();
    |                             ^^^^^^^^^^ not found in `rand`

error[E0425]: cannot find function `thread_rng` in crate `rand`
   --> src/gameplay/table_de_conversion.rs:544:29
    |
...
error[E0382]: borrow of moved value: `niveau_7`
   --> src/gameplay/tresor.rs:280:13
    |
260 |         let mut niveau_7 = HashMap::new();
    |             ------------ move occurs because `niveau_7` has type `HashMap<std::string::String, u32>`, which does not implement the `Copy` trait
...
271 |         objets_garantis.insert(7, niveau_7);
    |                                   -------- value moved here
...
280 |             niveau_7.insert("gemmes".to_string(), 1);
    |             ^^^^^^^^ value borrowed here after move
    |
help: consider cloning the value if the performance cost is acceptable
    |
271 |         objets_garantis.insert(7, niveau_7.clone());
    |                                           ++++++++

Some errors have detailed explanations: E0382, E0425, E0432.
For more information about an error, try `rustc --explain E0382`.
warning: `the-last-signal-server` (lib) generated 2 warnings
error: could not compile `the-last-signal-server` (lib) due to 7 previous errors; 2 warnings emitted
warning: build failed, waiting for other jobs to finish...
warning: `the-last-signal-server` (lib test) generated 2 warnings (2 duplicates)
error: could not compile `the-last-signal-server` (lib test) due to 7 previous errors; 2 warnings emitted
