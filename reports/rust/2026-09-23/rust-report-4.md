...
Run : 2023
Branch : main
Commit : 508a4a98ccfe062321677bb7cfb802d789fa5208
Date : Wed Sep 23 20:26:49 UTC 2026
...
-    ) -> Self {
+    pub fn new(nom: &str, image: Option<&str>, quantite: u128, type_objet: TypeObjet) -> Self {
         Self {
...
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/gameplay/stuff_manager.rs:195:
...
-        ));
-    }
+    pub async fn retirer_objet(&mut self, nom: &str, quantite: u64) -> Result<(), sqlx::Error> {
+        // Une quantité nulle n'est pas une opération valide.
+        if quantite == 0 {
+            return Err(sqlx::Error::Protocol(
+                "La quantité à retirer doit être supérieure à 0".into(),
...
error[E0308]: mismatched types
   --> src/gameplay/stuff_manager.rs:193:68
    |
193 |             _ => ObjetInventaire::Base(Objet::new(&row.nom, image, qte, TypeObjet::DeBase)),
    |                                        ----------                  ^^^ expected `u128`, found `u64`
    |                                        |
    |                                        arguments to this function are incorrect
    |
note: associated function defined here
   --> src/gameplay/objets.rs:37:12
    |
 37 |     pub fn new(
    |            ^^^
...
...
help: you can convert a `u64` to a `u128`
    |
193 |             _ => ObjetInventaire::Base(Objet::new(&row.nom, image, qte.into(), TypeObjet::DeBase)),
    |                                                                       +++++++
...
help: you can convert a `u128` to a `u64` and panic if the converted value doesn't fit
   |
45 |             quantite: quantite.try_into().unwrap(),
   |             +++++++++         ++++++++++++++++++++

error[E0308]: mismatched types
   --> src/gameplay/objets.rs:120:45
    |
120 |         let  objet = Objet::new(nom, image, quantite, TypeObjet::Equipement);
    |                      ----------             ^^^^^^^^ expected `u128`, found `u64`
    |                      |
    |                      arguments to this function are incorrect
    |
...
help: you can convert a `u64` to a `u128`
    |
120 |         let  objet = Objet::new(nom, image, quantite.into(), TypeObjet::Equipement);
    |                                                     +++++++
...
error[E0308]: mismatched types
   --> src/gameplay/objets.rs:241:44
    |
241 |         let objet = Objet::new(nom, image, quantite, TypeObjet::Potion);
    |                     ----------             ^^^^^^^^ expected `u128`, found `u64`
    |                     |
    |                     arguments to this function are incorrect
    |
...
help: you can convert a `u64` to a `u128`
    |
241 |         let objet = Objet::new(nom, image, quantite.into(), TypeObjet::Potion);
    |                                                    +++++++

error[E0308]: mismatched types
   --> src/gameplay/objets.rs:288:44
    |
288 |         let objet = Objet::new(nom, image, quantite, TypeObjet::Livre);
    |                     ----------             ^^^^^^^^ expected `u128`, found `u64`
    |                     |
    |                     arguments to this function are incorrect
    |
...
help: you can convert a `u64` to a `u128`
    |
288 |         let objet = Objet::new(nom, image, quantite.into(), TypeObjet::Livre);
    |                                                    +++++++
...
error: could not compile `the-last-signal-server` (lib) due to 15 previous errors; 1 warning emitted
warning: build failed, waiting for other jobs to finish...
warning: `the-last-signal-server` (lib test) generated 1 warning (1 duplicate)
error: could not compile `the-last-signal-server` (lib test) due to 15 previous errors; 1 warning emitted
