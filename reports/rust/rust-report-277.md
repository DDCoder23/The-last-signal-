...
Run : 277
Branch : main
Commit : ec0167aab0a8f3fb05fad09ba329b6925135829d
Date : Sun Aug  9 03:50:28 UTC 2026
...
error: cannot find macro `debug` in this scope
   --> tests/integration_test.rs:150:5
    |
150 |     debug!(message.to_string)
    |     ^^^^^

error[E0061]: this function takes 3 arguments but 2 arguments were supplied
   --> tests/integration_test.rs:149:19
    |
149 |     let message = Tresor::ouvrir(1,true);
    |                   ^^^^^^^^^^^^^^ - argument #1 of type `&Tresor` is missing
    |
note: method defined here
   --> src/gameplay/tresor.rs:286:12
    |
286 |     pub fn ouvrir(
    |            ^^^^^^
help: provide the argument
    |
149 -     let message = Tresor::ouvrir(1,true);
149 +     let message = Tresor::ouvrir(/* &Tresor */, 1, true);
    |

For more information about this error, try `rustc --explain E0061`.
error: could not compile `the-last-signal-server` (test "integration_test") due to 2 previous errors
