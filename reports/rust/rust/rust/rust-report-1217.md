...
Date : Sun Aug 23 14:56:34 UTC 2026
...
warning: unnecessary parentheses around `return` value
   --> src/network/handler.rs:423:24
    |
423 |                 return (Packet::new(PacketType::Move, packet.payload))
    |                        ^                                             ^
    |
...
help: try wrapping the expression in `Some`
    |
423 |                 return Some((Packet::new(PacketType::Move, packet.payload)))
    |                        +++++                                               +

For more information about this error, try `rustc --explain E0308`.
warning: `the-last-signal-server` (lib) generated 5 warnings
error: could not compile `the-last-signal-server` (lib) due to 2 previous errors; 5 warnings emitted
warning: build failed, waiting for other jobs to finish...
warning: `the-last-signal-server` (lib test) generated 5 warnings (5 duplicates)
error: could not compile `the-last-signal-server` (lib test) due to 2 previous errors; 5 warnings emitted
