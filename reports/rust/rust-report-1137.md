...
Date : Sat Aug 22 21:56:03 UTC 2026
...
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/client.rs:60:
         );
...
-
                 ...
                 Err(e) => {
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/client.rs:100:
...
error[E0616]: field `user_id` of struct `Client` is private
   --> src/network/handler.rs:115:32
    |
115 |                         client.user_id = Some(user_id.clone());
    |                                ^^^^^^^ private field

error[E0616]: field `user_id` of struct `Client` is private
   --> src/network/handler.rs:366:24
    |
366 |                 client.user_id = Some(login_data.user_id.clone());
    |                        ^^^^^^^ private field
