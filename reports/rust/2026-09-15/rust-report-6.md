...
Date : Tue Sep 15 18:59:32 UTC 2026
...
+        ]);
         ...
         Self {
             loot_par_niveau,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/gameplay/tresor.rs:514:
...
+                    r#"
                 ...
                 FROM echecs
                 WHERE account_id = ?
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/gameplay/tresor.rs:700:
                   AND categorie = ?
                   AND objet = ?
                 "#,
-            )
...
+                        r#"
                     INSERT INTO echecs (
                         account_id,
                         categorie,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/gameplay/tresor.rs:775:
                     DO UPDATE SET
                         nombre = 0
                     "#,
-                )
...
+                r#"
             ...
             FROM echecs
             WHERE account_id = ?
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/gameplay/tresor.rs:888:
               AND categorie = ?
               AND objet = ?
             "#,
-        )
...
+                    r#"
                 INSERT INTO echecs (
                     account_id,
                     categorie,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/gameplay/tresor.rs:959:
                 DO UPDATE SET
                     nombre = 0
                 "#,
-            )
...
+                    r#"
                 INSERT INTO echecs (
                     account_id,
                     categorie,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/gameplay/tresor.rs:989:
                 DO UPDATE SET
                     nombre = nombre + 1
                 "#,
-            )
...
error[E0063]: missing field `seuil_artefact_rare` in initializer of `Tresor`
   --> src/gameplay/tresor.rs:507:9
    |
507 |         Self {
    |         ^^^^ missing `seuil_artefact_rare`
...
error: could not compile `the-last-signal-server` (lib test) due to 1 previous error; 1 warning emitted
