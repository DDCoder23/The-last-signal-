...
- **Module :** python
- **Message :** La fonction 'encode'ligne 27 ne possède pas de docstring.
...
- **Module :** python
- **Message :** La fonction 'decode'ligne 49 ne possède pas de docstring.
...
- **Module :** python
- **Message :** La fonction 'open_database'ligne 44 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'get_tables'ligne 50 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'check_integrity'ligne 61 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'check_foreign_keys'ligne 70 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'get_table_schema'ligne 76 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'get_row_count'ligne 83 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'create_test_database'ligne 92 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'attack_delete'ligne 111 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'attack_drop_table'ligne 129 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'attack_update'ligne 147 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'attack_invalid_insert'ligne 178 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'attack_large_value'ligne 224 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_payload_as_parameter'ligne 258 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'verify_database'ligne 275 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_sql_injection'ligne 285 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_sql_injection' ne possède pas d'annotations de type.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_sql_injection' dépasse 80 lignes.
