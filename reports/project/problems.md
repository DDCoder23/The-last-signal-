...
- **Module :** python
- **Message :** La fonction 'main'ligne 8 ne possède pas de docstring.
...
- **Module :** python
- **Message :** La fonction 'test_data' ne possède pas d'annotations de type.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'rotor_groups'ligne 89 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'rotor_groups' ne possède pas d'annotations de type.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'mix_before' ne possède pas d'annotations de type.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'inverse_mix_before' ne possède pas d'annotations de type.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'mix_final' ne possède pas d'annotations de type.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'inverse_mix_final' ne possède pas d'annotations de type.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_rotl_rotr_inverse'ligne 362 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_rotl_rotr_inverse' ne possède pas d'annotations de type.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_mix_before_is_reversible'ligne 374 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_mix_before_is_reversible' ne possède pas d'annotations de type.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_mix_final_is_reversible'ligne 394 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_mix_final_is_reversible' ne possède pas d'annotations de type.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_complete_mix_chain'ligne 414 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_complete_mix_chain' ne possède pas d'annotations de type.
...
- **Module :** python
- **Message :** La fonction 'main'ligne 85 ne possède pas de docstring.
...
- **Module :** python
- **Message :** La fonction 'create_login_packet'ligne 32 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'receive_packet'ligne 47 ne possède pas de docstring.
...
- **Module :** python
- **Message :** La fonction 'test_payload'ligne 70 ne possède pas de docstring.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'test_payload' ne possède pas d'annotations de type.

## ⚠️ Warning

- **Module :** python
- **Message :** La fonction 'main'ligne 108 ne possède pas de docstring.
...
- **Module :** titles
- **Message :** docs/CODING_RULES.md:363 titre dupliqué (déjà présent dans README.md:104).
...
- **Module :** titles
- **Message :** docs/README.md:2 titre dupliqué (déjà présent dans README.md:2).
...
- **Module :** titles
- **Message :** docs/gdd/README.md:2 titre dupliqué (déjà présent dans README.md:2).
