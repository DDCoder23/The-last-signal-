...
Date : Tue Aug 18 22:18:28 CUT 2026
...
Compiling 'tests\\test_fuzzing.py'...
Compiling 'tests\\test_load.py'...
Compiling 'tests\\test_sql_injection.py'...

## Rust
[1m[92m    Updating[0m crates.io index
[1m[92m     Locking[0m 237 packages to latest Rust 1.97.1 compatible versions
[1m[92m      Adding[0m generic-array v0.14.7 [1m[93m(available: v0.14.9)[0m
[1m[92m      Adding[0m rand_core v0.6.4 [1m[93m(available: v0.10.1)[0m
...
[1m[92m  Downloaded[0m winapi-util v0.1.11
...
Caused by:
  process didn't exit successfully: `D:\a\The-last-signal-\The-last-signal-\server_rust\target\release\build\openssl-sys-c8cabd5eca73fe16\build-script-main` (exit code: 101)
  --- stdout
