...
Run : 503
Branch : main
Commit : 9df0f790ac13475fff7ab8747d2eb423449f7c2f
Date : Wed Aug 12 02:34:31 UTC 2026
...
error[E0308]: mismatched types
  --> src/database/migrations.rs:46:5
   |
43 |     create_user(
...
note: function defined here
  --> src/database/migrations.rs:62:10
   |
62 | async fn create_user(
   |          ^^^^^^^^^^^
...
...
error[E0308]: mismatched types
  --> src/database/migrations.rs:53:5
   |
50 | create_user(
   | ----------- arguments to this function are incorrect
...
...
Some errors have detailed explanations: E0308, E0583, E0599.
For more information about an error, try `rustc --explain E0308`.
warning: `the-last-signal-server` (lib) generated 4 warnings
error: could not compile `the-last-signal-server` (lib) due to 5 previous errors; 4 warnings emitted
warning: build failed, waiting for other jobs to finish...
warning: `the-last-signal-server` (lib test) generated 4 warnings (4 duplicates)
error: could not compile `the-last-signal-server` (lib test) due to 5 previous errors; 4 warnings emitted
