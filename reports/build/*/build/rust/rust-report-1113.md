...
Date : Sat Aug 22 14:06:00 UTC 2026
...
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/database/database_manager.rs:69:
-
-
-    
-
...
+    pub async fn new(database_path: &str, database_url: &str) -> Result<Self, sqlx::Error> {
         ...
         // --------------------------------------------------
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/database/database_manager.rs:81:
...
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/database/database_manager.rs:106:
...
+                    pool = Self::create_database(database_url).await?;
                 ...
                 Ok(false) => {
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/database/database_manager.rs:129:
                     return Err(error);
                 }
             }
-        } 
...
-        
         ...
         // --------------------------------------------------
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/database/database_manager.rs:138:
...
-                    {
-
+                    let response = PacketHandler::handle(self, packet, self.pool.clone()).await;
...
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:17:
 }
...
-    ) -> Packet {
-
+    pub async fn handle(_client: &mut Client, packet: Packet, pool: SqlitePool) -> Packet {
...
+                    r#"
         SELECT EXISTS(
             SELECT 1
             FROM users
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:139:
             WHERE email = ?
         )
         "#,
-    )
...
+                    r#"
         INSERT INTO users (
             user_id,
             email,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:219:
         )
         VALUES (?, ?, ?)
         "#,
-        )
...
+                    r#"
         SELECT
             user_id,
             password_hash
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:293:
         FROM users
         WHERE email = ?
-        "#,)
-        .bind(&email)
...
+                    r#"
     ...
     WHERE id = ?
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:337:
       AND status != 'CONNECED'
     "#,
-)
-.bind(&user.user_id)
...
-            r#"
+                let banned_permanently = match sqlx::query_scalar(
+                    r#"
             SELECT EXISTS(
                 SELECT 1
                 FROM bansperm
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:377:
                 WHERE user_id = ?
             )
-            "#,)
-            .bind(&user.user_id)
...
-        match sqlx::query_scalar(
-            r#"
+                let banned_temporarily = match sqlx::query_scalar(
+                    r#"
             SELECT EXISTS(
                 SELECT 1
                 FROM bansferme
...
+                        r#"
             INSERT INTO login_attempts (
                 user_id,
                 failed_attempts,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:497:
                     CURRENT_TIMESTAMP
...
+                            r#"
                 INSERT INTO bansferme (
                     user_id,
                     auteur,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:567:
                             CURRENT_TIMESTAMP,
                             '+10 minutes'
                         )
-                "#,)
...
+                )
             ...
             PacketType::Chat => {
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:678:
...
+                Packet::new(PacketType::Chat, packet.payload)
             ...
             PacketType::Move => {
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:694:
-
...
-
 ...
 /// Types de paquets.
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/packet.rs:23:
     SignUp = 6,
 }
...
-
 ...
 pub enum LogLevel {
     TRACE,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/packet.rs:33:
     ERROR,
 }
...
-
 ...
 pub struct ClientLog {
     pub level: LogLevel,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/packet.rs:64:
 }
...
+    pub fn new(packet_type: PacketType, payload: Vec<u8>) -> Self {
         Self {
             packet_type,
             payload,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/packet.rs:76:
 }
...
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/packet.rs:95:
...
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/packet.rs:119:
 }
...
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/packet.rs:129:
...
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/packet.rs:153:
...
error[E0277]: can't compare `!` with `i32`
   --> src/network/handler.rs:533:21
    |
533 |         if attempts >= 3 {
    |                     ^^ no implementation for `! < i32` and `! > i32`
    |
help: the trait `PartialOrd<i32>` is not implemented for `!`
      but trait `PartialOrd<!>` is implemented for it
   --> /rustc/88d9e12ae178fab0fb5cc050a94da85685d449ea/library/core/src/cmp.rs:2097:4
    = help: for that trait implementation, expected `!`, found `i32`

error[E0277]: the trait bound `!: sqlx::Decode<'_, Sqlite>` is not satisfied
   --> src/network/handler.rs:502:10
    |
502 |         .fetch_one(&pool)
    |          ^^^^^^^^^ the trait `sqlx::Decode<'_, Sqlite>` is not implemented for `!`
    |
    = help: the following other types implement trait `sqlx::Decode<'r, DB>`:
              ...
              `Arc<T>` implements `sqlx::Decode<'r, DB>`
              `Arc<[u8]>` implements `sqlx::Decode<'r, DB>`
              `Arc<str>` implements `sqlx::Decode<'r, DB>`
            and 50 others
    = note: required for `(!,)` to implement `for<'r> FromRow<'r, SqliteRow>`
note: required by a bound in `QueryScalar::<'q, DB, O, A>::fetch_one`
   --> /home/runner/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/sqlx-core-0.9.0/src/query_scalar.rs:85:26
    |
...
error[E0277]: the trait bound `!: sqlx::Type<Sqlite>` is not satisfied
   --> src/network/handler.rs:502:10
    |
502 |         .fetch_one(&pool)
    |          ^^^^^^^^^ the trait `sqlx::Type<Sqlite>` is not implemented for `!`
    |
...
error[E0277]: the trait bound `!: sqlx::Decode<'_, Sqlite>` is not satisfied
   --> src/network/handler.rs:478:30
    |
478 |           let attempts = match sqlx::query_scalar(
    |  ______________________________^
479 | |             r#"
480 | |             INSERT INTO login_attempts (
481 | |                 user_id,
...   |
501 | |             .bind(&user.user_id)
502 | |         .fetch_one(&pool)
    | |_________________________^ the trait `sqlx::Decode<'_, Sqlite>` is not implemented for `!`
    |
    = help: the following other types implement trait `sqlx::Decode<'r, DB>`:
              `&'a str` implements `sqlx::Decode<'a, sqlx::Any>`
              `&'r JsonRawValue` implements `sqlx::Decode<'r, DB>`
...
501 | |             .bind(&user.user_id)
502 | |         .fetch_one(&pool)
    | |_________________________^ the trait `sqlx::Type<Sqlite>` is not implemented for `!`
    |
    = help: the following other types implement trait `sqlx::Type<DB>`:
              DateTime<Tz>
              Hyphenated
...
481 | |                 user_id,
...   |
499 | |             RETURNING failed_attempts
500 | |             "#,)
    | |________________^ the trait `sqlx::Decode<'_, Sqlite>` is not implemented for `!`
    |
    = help: the following other types implement trait `sqlx::Decode<'r, DB>`:
              `&'a str` implements `sqlx::Decode<'a, sqlx::Any>`
              `&'r JsonRawValue` implements `sqlx::Decode<'r, DB>`
...
note: required by a bound in `sqlx::query_scalar`
   --> /home/runner/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/sqlx-core-0.9.0/src/query_scalar.rs:327:11
    |
322 | pub fn query_scalar<'q, DB, O>(
...
499 | |             RETURNING failed_attempts
500 | |             "#,)
    | |________________^ the trait `sqlx::Type<Sqlite>` is not implemented for `!`
    |
    = help: the following other types implement trait `sqlx::Type<DB>`:
              DateTime<Tz>
              Hyphenated
...
error: could not compile `the-last-signal-server` (lib) due to 8 previous errors; 4 warnings emitted
