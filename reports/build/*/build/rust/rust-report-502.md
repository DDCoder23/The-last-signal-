...
Run : 502
Branch : main
Commit : 003cafa4406fbc9d9286745257d3f8836ecb6bcc
Date : Wed Aug 12 02:35:49 UTC 2026
...
error[E0583]: file not found for module `vault`
 --> src/database/mod.rs:3:1
  |
3 | pub mod vault;
  | ^^^^^^^^^^^^^^
  |
  = help: to create the module `vault`, create file "src/database/vault.rs" or "src/database/vault/mod.rs"
  = note: if there is a `mod vault` elsewhere in the crate already, import it with `use crate::...` instead

error[E0432]: unresolved import `crate::utils::password`
 --> src/database/migrations.rs:5:19
  |
5 | use crate::utils::password::hash_password;
  |                   ^^^^^^^^ could not find `password` in `utils`
...
Some errors have detailed explanations: E0308, E0432, E0583, E0599.
For more information about an error, try `rustc --explain E0308`.
warning: `the-last-signal-server` (lib) generated 4 warnings
error: could not compile `the-last-signal-server` (lib) due to 4 previous errors; 4 warnings emitted
warning: build failed, waiting for other jobs to finish...
warning: `the-last-signal-server` (lib test) generated 4 warnings (4 duplicates)
error: could not compile `the-last-signal-server` (lib test) due to 4 previous errors; 4 warnings emitted
