...
Date : Sun Aug 23 17:39:25 UTC 2026
...
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:423:
...
error[E0004]: non-exhaustive patterns: `PacketType::LoginResponse` and `PacketType::SignUpResponse` not covered
   --> src/network/handler.rs:36:15
    |
 36 |         match packet.packet_type {
    |               ^^^^^^^^^^^^^^^^^^ patterns `PacketType::LoginResponse` and `PacketType::SignUpResponse` not covered
    |
...
help: ensure that all possible cases are being handled by adding a match arm with a wildcard pattern, a match arm with multiple or-patterns as shown, or multiple match arms
    |
424 ~             },
425 ~             PacketType::LoginResponse | PacketType::SignUpResponse => todo!(),
    |

For more information about this error, try `rustc --explain E0004`.
warning: `the-last-signal-server` (lib) generated 4 warnings
error: could not compile `the-last-signal-server` (lib) due to 1 previous error; 4 warnings emitted
