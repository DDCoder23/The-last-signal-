...
Date : Sun Aug  9 22:53:03 UTC 2026
...
error[E0061]: this method takes 3 arguments but 2 arguments were supplied
   --> src/gameplay/tresor.rs:383:30
    |
383 |               let objet = self.tirer_objet(
    |  ______________________________^^^^^^^^^^^-
384 | |                 "Artefact commun",
385 | |                 &mut rng,
386 | |             );
    | |_____________- argument #3 of type `bool` is missing
    |
note: method defined here
   --> src/gameplay/tresor.rs:443:12
    |
443 |     pub fn tirer_objet(
    |            ^^^^^^^^^^^
...
447 |     is_admin: bool,
    |     --------------
...
error[E0061]: this method takes 3 arguments but 2 arguments were supplied
   --> src/gameplay/tresor.rs:401:30
    |
401 |               let objet = self.tirer_objet(
    |  ______________________________^^^^^^^^^^^-
402 | |                 "Artefact admin",
403 | |                 &mut rng,
404 | |             );
...
error[E0061]: this function takes 2 arguments but 3 arguments were supplied
   --> src/gameplay/tresor.rs:464:20
    |
464 |     let resultat = Self::tirer_pondere(
    |                    ^^^^^^^^^^^^^^^^^^^
...
467 |         is_admin
...
note: associated function defined here
   --> src/gameplay/tresor.rs:419:12
    |
419 |     pub fn tirer_pondere(
    |            ^^^^^^^^^^^^^
...
error[E0061]: this method takes 3 arguments but 2 arguments were supplied
   --> src/gameplay/tresor.rs:471:21
    |
471 |           return self.tirer_objet(
    |  _____________________^^^^^^^^^^^-
472 | |             &resultat,
473 | |             rng,
474 | |         );
    | |_________- argument #3 of type `bool` is missing
    |
note: method defined here
   --> src/gameplay/tresor.rs:443:12
    |
