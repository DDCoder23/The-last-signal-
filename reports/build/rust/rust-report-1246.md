...
Date : Mon Aug 24 10:13:11 UTC 2026
...
error[E0004]: non-exhaustive patterns: `PacketType::BAN` not covered
   --> src/network/handler.rs:36:15
    |
 36 |         match packet.packet_type {
    |               ^^^^^^^^^^^^^^^^^^ pattern `PacketType::BAN` not covered
    |
note: `PacketType` defined here
   --> src/network/packet.rs:17:10
    |
 17 | pub enum PacketType {
    |          ^^^^^^^^^^
...
 26 |     BAN = 9,
    |     --- not covered
    = note: the matched value is of type `PacketType`
help: ensure that all possible cases are being handled by adding a match arm with a wildcard pattern or an explicit pattern as shown
    |
433 ~            },
434 ~             PacketType::BAN => todo!(),
    |

Some errors have detailed explanations: E0004, E0599.
For more information about an error, try `rustc --explain E0004`.
warning: `the-last-signal-server` (lib) generated 4 warnings
error: could not compile `the-last-signal-server` (lib) due to 3 previous errors; 4 warnings emitted
warning: build failed, waiting for other jobs to finish...
warning: `the-last-signal-server` (lib test) generated 4 warnings (4 duplicates)
error: could not compile `the-last-signal-server` (lib test) due to 3 previous errors; 4 warnings emitted
