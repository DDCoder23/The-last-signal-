...
Date : Tue Aug 18 01:39:10 UTC 2026
...
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/database/database_manager.rs:108:
...
+                    std::fs::remove_file(database_file).map_err(sqlx::Error::Io)?;
                 ...
                 Ok(false) => {
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/database/database_manager.rs:139:
...
note: found an item that was configured out
  --> /home/runner/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/rand_core-0.6.4/src/lib.rs:49:43
   |
...
error[E0425]: cannot find function `thread_rng` in crate `rand`
 --> src/gameplay/dice.rs:4:25
  |
4 |     let mut rng = rand::thread_rng();
  |                         ^^^^^^^^^^ not found in `rand`

error[E0425]: cannot find function `thread_rng` in crate `rand`
  --> src/gameplay/tresor.rs:44:29
   |
44 |         let mut rng = rand::thread_rng();
   |                             ^^^^^^^^^^ not found in `rand`

error[E0425]: cannot find function `thread_rng` in crate `rand`
   --> src/gameplay/tresor.rs:415:25
    |
...
error[E0599]: no method named `gen_range` found for mutable reference `&mut impl Rng` in the current scope
   --> src/gameplay/tresor.rs:517:22
    |
517 |     let tirage = rng.gen_range(0.0..total);
    |                      ^^^^^^^^^ method not found in `&mut impl Rng`
...
error: could not compile `the-last-signal-server` (lib) due to 5 previous errors; 3 warnings emitted
warning: build failed, waiting for other jobs to finish...
warning: `the-last-signal-server` (lib test) generated 3 warnings (3 duplicates)
error: could not compile `the-last-signal-server` (lib test) due to 5 previous errors; 3 warnings emitted
