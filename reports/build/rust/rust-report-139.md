...
Run : 139
Branch : main
Commit : d223e3f8f62b4dd5e9a7b91db143c23d141f5ef3
Date : Mon Aug  3 23:22:48 UTC 2026
...
[1m[33mwarning[0m[1m: unused imports: `Pbkdf2` and `rand_core::RngCore`[0m
  [1m[94m--> [0msrc/utils/save/encryptions.rs:20:9
   [1m[94m|[0m
[1m[94m20[0m [1m[94m|[0m         rand_core::RngCore,
   [1m[94m|[0m         [1m[33m^^^^^^^^^^^^^^^^^^[0m
[1m[94m...[0m
[1m[94m23[0m [1m[94m|[0m     Pbkdf2,
   [1m[94m|[0m     [1m[33m^^^^^^[0m
   [1m[94m|[0m
...
[1m[33mwarning[0m: `the-last-signal-server` (lib) generated 2 warnings (run `cargo fix --lib -p the-last-signal-server` to apply 1 suggestion)
[1m[91merror[E0432][0m[1m: unresolved import `the_last_signal_server::log`[0m
 [1m[94m--> [0msrc/main.rs:6:29
  [1m[94m|[0m
[1m[94m6[0m [1m[94m|[0m use the_last_signal_server::log::info;
  [1m[94m|[0m                             [1m[91m^^^[0m [1m[91mcould not find `log` in `the_last_signal_server`[0m

[1m[91merror[E0432][0m[1m: unresolved import `packet`[0m
 [1m[94m--> [0msrc/main.rs:1:5
  [1m[94m|[0m
[1m[94m1[0m [1m[94m|[0m use packet::PacketType;
  [1m[94m|[0m     [1m[91m^^^^^^[0m [1m[91muse of unresolved module or unlinked crate `packet`[0m
  [1m[94m|[0m
  [1m[94m= [0m[1mhelp[0m: if you wanted to use a crate named `packet`, use `cargo add packet` to add it to your `Cargo.toml`

[1mFor more information about this error, try `rustc --explain E0432`.[0m
[1m[91merror[0m: could not compile `the-last-signal-server` (bin "the-last-signal-server") due to 2 previous errors
[1m[33mwarning[0m: build failed, waiting for other jobs to finish...
[1m[91merror[0m: could not compile `the-last-signal-server` (bin "the-last-signal-server" test) due to 2 previous errors
[1m[91merror[E0432][0m[1m: unresolved import `the_last_signal_server::packet`[0m
 [1m[94m--> [0mtests/integration_test.rs:1:29
  [1m[94m|[0m
[1m[94m1[0m [1m[94m|[0m use the_last_signal_server::packet::PacketType;
  [1m[94m|[0m                             [1m[91m^^^^^^[0m [1m[91mcould not find `packet` in `the_last_signal_server`[0m

[1m[91merror[E0432][0m[1m: unresolved import `the_last_signal_server::utils::save::SaveManager`[0m
  [1m[94m--> [0mtests/integration_test.rs:10:5
   [1m[94m|[0m
[1m[94m10[0m [1m[94m|[0m     SaveManager,
   [1m[94m|[0m     [1m[91m^^^^^^^^^^^[0m [1m[91mno `SaveManager` in `utils::save`[0m

[1m[91merror[0m: could not compile `the-last-signal-server` (test "integration_test") due to 2 previous errors
[1m[33mwarning[0m: `the-last-signal-server` (lib test) generated 2 warnings (2 duplicates)
