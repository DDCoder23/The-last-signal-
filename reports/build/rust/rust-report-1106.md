...
Date : Sat Aug 22 10:05:37 UTC 2026
...
+use crate::utils::password::{hash_password, verify_password};
 ...
 use uuid::Uuid;
 impl PacketHandler {
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:13:
-
-    pub async fn handle(
-        _client: &mut Client,
-        packet: Packet,
...
+                    r#"
         SELECT EXISTS(
             SELECT 1
             FROM users
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:132:
             WHERE email = ?
         )
         "#,
-    )
...
+                    r#"
         INSERT INTO users (
             user_id,
             email,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:212:
         )
         VALUES (?, ?, ?)
         "#,
-        )
...
+                    r#"
         SELECT
             user_id,
             password_hash
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:286:
         FROM users
         WHERE email = ?
-        "#,)
-        .bind(email)
...
+                    r#"
     ...
     WHERE id = ?
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:325:
       AND status != 'CONNECED'
     "#,
-)
-.bind(&user.user_id)
...
+                    r#"
             SELECT EXISTS(
                 SELECT 1
                 FROM bansperm
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:365:
                 WHERE user_id = ?
             )
-            "#,)
-            .bind(&user.user_id)
...
+                    r#"
             SELECT EXISTS(
                 SELECT 1
                 FROM bansferme
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:412:
                 WHERE user_id = ?
...
+                        r#"
             INSERT INTO login_attempts (
                 user_id,
                 failed_attempts,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:485:
                     CURRENT_TIMESTAMP
...
+                            r#"
                 INSERT INTO bansferme (
                     user_id,
                     auteur,
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:555:
                             CURRENT_TIMESTAMP,
                             '+10 minutes'
                         )
-                "#,)
...
+                )
             ...
             PacketType::Chat => {
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:666:
...
+                Packet::new(PacketType::Chat, packet.payload)
             ...
             PacketType::Move => {
Diff in /home/runner/work/The-last-signal-/The-last-signal-/server_rust/src/network/handler.rs:682:
-
...
error[E0609]: no field `user_id` on type `SqliteRow`
   --> src/network/handler.rs:328:13
    |
328 | .bind(&user.user_id)
    |             ^^^^^^^ unknown field

error[E0609]: no field `user_id` on type `SqliteRow`
   --> src/network/handler.rs:368:25
    |
368 |             .bind(&user.user_id)
    |                         ^^^^^^^ unknown field

error[E0609]: no field `user_id` on type `SqliteRow`
   --> src/network/handler.rs:416:25
    |
...
error[E0609]: no field `user_id` on type `SqliteRow`
   --> src/network/handler.rs:489:25
    |
489 |             .bind(&user.user_id)
    |                         ^^^^^^^ unknown field

error[E0609]: no field `user_id` on type `SqliteRow`
   --> src/network/handler.rs:559:29
    |
559 |                 .bind(&user.user_id)
    |                             ^^^^^^^ unknown field

error[E0609]: no field `user_id` on type `SqliteRow`
   --> src/network/handler.rs:584:29
    |
584 |                 .bind(&user.user_id)
    |                             ^^^^^^^ unknown field

error[E0609]: no field `user_id` on type `SqliteRow`
   --> src/network/handler.rs:629:21
    |
...
error: could not compile `the-last-signal-server` (lib test) due to 8 previous errors; 4 warnings emitted
