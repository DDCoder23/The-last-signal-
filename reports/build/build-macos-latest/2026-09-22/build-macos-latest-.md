...
OS : macos-latest
Branch : main
Commit : 778e066b6c8d856d2de271a69f454cc738bf3ad4
Date : Tue Sep 22 15:03:11 UTC 2026
...
[1m[33mwarning[0m[1m: field `pool` is never read[0m
  [1m[94m--> [0msrc/gameplay/stuff_manager.rs:60:5
   [1m[94m|[0m
[1m[94m59[0m [1m[94m|[0m pub struct Inventaire {
   [1m[94m|[0m            [1m[94m----------[0m [1m[94mfield in this struct[0m
[1m[94m60[0m [1m[94m|[0m     pool: SqlitePool,
   [1m[94m|[0m     [1m[33m^^^^[0m

[1m[33mwarning[0m: `the-last-signal-server` (lib) generated 5 warnings (run `cargo fix --lib -p the-last-signal-server` to apply 1 suggestion)
...
[1m[92m    Finished[0m `release` profile [optimized] target(s) in 1m 52s
