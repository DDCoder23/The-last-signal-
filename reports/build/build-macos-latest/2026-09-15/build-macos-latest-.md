...
OS : macos-latest
Branch : main
Commit : fad970a145fd4a3e2d783682fe49271194333d08
Date : Tue Sep 15 19:00:45 UTC 2026
...
[1m[91merror[E0063][0m[1m: missing field `seuil_artefact_rare` in initializer of `Tresor`[0m
   [1m[94m--> [0msrc/gameplay/tresor.rs:507:9
    [1m[94m|[0m
[1m[94m507[0m [1m[94m|[0m         Self {
    [1m[94m|[0m         [1m[91m^^^^[0m [1m[91mmissing `seuil_artefact_rare`[0m

[1mFor more information about this error, try `rustc --explain E0063`.[0m
[1m[33mwarning[0m: `the-last-signal-server` (lib) generated 1 warning
[1m[91merror[0m: could not compile `the-last-signal-server` (lib) due to 1 previous error; 1 warning emitted
