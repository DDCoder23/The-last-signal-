...
Date : Wed Sep  9 20:59:08 UTC 2026
...
[1m[33mwarning[0m[1m: fields `user_id` and `password_hash` are never read[0m
  [1m[94m--> [0msrc/network/handler.rs:41:5
   [1m[94m|[0m
[1m[94m40[0m [1m[94m|[0m pub struct User {
   [1m[94m|[0m            [1m[94m----[0m [1m[94mfields in this struct[0m
[1m[94m41[0m [1m[94m|[0m     user_id: String,
   [1m[94m|[0m     [1m[33m^^^^^^^[0m
[1m[94m42[0m [1m[94m|[0m     password_hash: String,
   [1m[94m|[0m     [1m[33m^^^^^^^^^^^^^[0m
   [1m[94m|[0m
   [1m[94m= [0m[1mnote[0m: `#[warn(dead_code)]` (part of `#[warn(unused)]`) on by default

[1m[33mwarning[0m[1m: constant `PO` is never used[0m
 [1m[94m--> [0msrc/gameplay/tresor.rs:8:7
  [1m[94m|[0m
[1m[94m8[0m [1m[94m|[0m const PO: u32 = PA * 10;
  [1m[94m|[0m       [1m[33m^^[0m

[1m[33mwarning[0m[1m: constant `PP` is never used[0m
 [1m[94m--> [0msrc/gameplay/tresor.rs:9:7
  [1m[94m|[0m
[1m[94m9[0m [1m[94m|[0m const PP: u32 = PO * 10;
  [1m[94m|[0m       [1m[33m^^[0m

[1m[33mwarning[0m: `the-last-signal-server` (lib) generated 3 warnings
[1m[91merror[E0608][0m[1m: cannot index into a value of type `fn(_) -> Vec<_, _> {<Vec<_, _> as From<_>>::from}`[0m
  [1m[94m--> [0msrc/main.rs:47:43
   [1m[94m|[0m
[1m[94m47[0m [1m[94m|[0m [1m[94m...[0m                   Vec::from["Aura de feu I"], 
   [1m[94m|[0m                                [1m[91m^^^^^^^^^^^^^^^^^[0m

[1m[91merror[E0061][0m[1m: this function takes 6 arguments but 5 arguments were supplied[0m
   [1m[94m--> [0msrc/main.rs:44:23
    [1m[94m|[0m
[1m[94m 44[0m [1m[94m|[0m                       Livre::new(String::from("livre enchant niv 1"), 
    [1m[94m|[0m                       [1m[91m^^^^^^^^^^[0m [1m[94m-----------------------------------[0m [1m[94mexpected `&str`, found `String`[0m
[1m[94m 45[0m [1m[94m|[0m                                  1, 
    [1m[94m|[0m                                  [1m[94m-[0m [1m[94margument #2 of type `Option<&str>` is missing[0m
    [1m[94m|[0m
[1m[92mnote[0m: expected `Option<Vec<String>>`, found `String`
   [1m[94m--> [0msrc/main.rs:46:34
    [1m[94m|[0m
[1m[94m 46[0m [1m[94m|[0m [1m[94m...[0m                   String::from("épée") , 
    [1m[94m|[0m                       [1m[92m^^^^^^^^^^^^^^^^^^^^[0m
    [1m[94m= [0m[1mnote[0m: expected enum `[1m[35mOption<Vec<String>>[0m`
             found struct `[1m[35mString[0m`
[1m[92mnote[0m: associated function defined here
   [1m[94m--> [0msrc/gameplay/objets.rs:284:12
    [1m[94m|[0m
[1m[94m284[0m [1m[94m|[0m     pub fn new(
    [1m[94m|[0m            [1m[92m^^^[0m
[1m[96mhelp[0m: consider borrowing here
    [1m[94m|[0m
[1m[94m 44[0m [1m[94m| [0m                      Livre::new([92m&[0mString::from("livre enchant niv 1"), 
    [1m[94m|[0m                                  [92m+[0m
[1m[96mhelp[0m: provide the argument
    [1m[94m|[0m
[1m[94m 44[0m [92m~ [0m                      Livre::new[92m([0m
[1m[94m 45[0m [92m+                                  /* &str */,[0m
[1m[94m 46[0m [92m+                                  /* Option<&str> */,[0m
[1m[94m 47[0m [92m+                                  1,[0m
[1m[94m 48[0m [92m+                                  Vec::from["Aura de feu I"],[0m
[1m[94m 49[0m [92m+                                  /* Option<Vec<String>> */,[0m
[1m[94m 50[0m [92m+                                 1,[0m
[1m[94m 51[0m [92m~                       )[0m);
    [1m[94m|[0m

[1m[91merror[E0608][0m[1m: cannot index into a value of type `fn(_) -> Vec<_, _> {<Vec<_, _> as From<_>>::from}`[0m
  [1m[94m--> [0msrc/main.rs:53:43
   [1m[94m|[0m
[1m[94m53[0m [1m[94m|[0m [1m[94m...[0m                   Vec::from["Aura de feu I"], 
   [1m[94m|[0m                                [1m[91m^^^^^^^^^^^^^^^^^[0m

[1m[91merror[E0061][0m[1m: this function takes 6 arguments but 5 arguments were supplied[0m
   [1m[94m--> [0msrc/main.rs:50:23
    [1m[94m|[0m
[1m[94m 50[0m [1m[94m|[0m                       Livre::new(String::from("livre enchant niv 1"), 
    [1m[94m|[0m                       [1m[91m^^^^^^^^^^[0m [1m[94m-----------------------------------[0m [1m[94mexpected `&str`, found `String`[0m
[1m[94m 51[0m [1m[94m|[0m                                  1, 
    [1m[94m|[0m                                  [1m[94m-[0m [1m[94margument #2 of type `Option<&str>` is missing[0m
    [1m[94m|[0m
[1m[92mnote[0m: expected `Option<Vec<String>>`, found `String`
   [1m[94m--> [0msrc/main.rs:52:34
    [1m[94m|[0m
[1m[94m 52[0m [1m[94m|[0m [1m[94m...[0m                   String::from("épée") , 
    [1m[94m|[0m                       [1m[92m^^^^^^^^^^^^^^^^^^^^[0m
    [1m[94m= [0m[1mnote[0m: expected enum `[1m[35mOption<Vec<String>>[0m`
             found struct `[1m[35mString[0m`
[1m[92mnote[0m: associated function defined here
...
[1m[96mhelp[0m: consider borrowing here
    [1m[94m|[0m
[1m[94m 50[0m [1m[94m| [0m                      Livre::new([92m&[0mString::from("livre enchant niv 1"), 
    [1m[94m|[0m                                  [92m+[0m
[1m[96mhelp[0m: provide the argument
    [1m[94m|[0m
[1m[94m 50[0m [92m~ [0m                      Livre::new[92m([0m
[1m[94m 51[0m [92m+                                  /* &str */,[0m
[1m[94m 52[0m [92m+                                  /* Option<&str> */,[0m
[1m[94m 53[0m [92m+                                  1,[0m
[1m[94m 54[0m [92m+                                  Vec::from["Aura de feu I"],[0m
[1m[94m 55[0m [92m+                                  /* Option<Vec<String>> */,[0m
[1m[94m 56[0m [92m+                                 1,[0m
[1m[94m 57[0m [92m~                       )[0m);
    [1m[94m|[0m

[1mSome errors have detailed explanations: E0061, E0608.[0m
[1mFor more information about an error, try `rustc --explain E0061`.[0m
[1m[91merror[0m: could not compile `the-last-signal-server` (bin "the-last-signal-server") due to 4 previous errors
