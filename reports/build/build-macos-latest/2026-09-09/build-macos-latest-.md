...
Date : Wed Sep  9 19:17:47 UTC 2026
...
[1m[91merror[0m[1m: this file contains an unclosed delimiter[0m
   [1m[94m--> [0msrc/gameplay/table_de_conversion.rs:580:14
    [1m[94m|[0m
[1m[94m 39[0m [1m[94m|[0m impl TableDeConversion {
    [1m[94m|[0m                        [1m[94m-[0m [1m[94munclosed delimiter[0m
[1m[94m...[0m
[1m[94m543[0m [1m[94m|[0m     ) -> Result<(), String> {
    [1m[94m|[0m                             [1m[94m-[0m [1m[94munclosed delimiter[0m
[1m[94m...[0m
[1m[94m546[0m [1m[94m|[0m         for _ in 0..nb {
    [1m[94m|[0m                        [1m[94m-[0m [1m[94munclosed delimiter[0m
[1m[94m...[0m
[1m[94m580[0m [1m[94m|[0m             
    [1m[94m|[0m             [1m[91m^[0m

[1m[91merror[0m: could not compile `the-last-signal-server` (lib) due to 1 previous error
