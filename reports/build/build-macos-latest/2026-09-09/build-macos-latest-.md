...
Date : Wed Sep  9 19:31:31 UTC 2026
...
[1m[91merror[E0432][0m[1m: unresolved import `crate::objets`[0m
 [1m[94m--> [0msrc/gameplay/table_de_conversion.rs:4:12
  [1m[94m|[0m
[1m[94m4[0m [1m[94m|[0m use crate::objets::{Livre, Objet};
  [1m[94m|[0m            [1m[91m^^^^^^[0m [1m[91munresolved import[0m
  [1m[94m|[0m
[1m[96mhelp[0m: a similar path exists
  [1m[94m|[0m
[1m[94m4[0m [1m[94m| [0muse crate::[92mgameplay::[0mobjets::{Livre, Objet};
  [1m[94m|[0m            [92m++++++++++[0m

[1m[91merror[E0425][0m[1m: cannot find function `thread_rng` in crate `rand`[0m
   [1m[94m--> [0msrc/gameplay/table_de_conversion.rs:211:29
    [1m[94m|[0m
[1m[94m211[0m [1m[94m|[0m         let mut rng = rand::thread_rng();
    [1m[94m|[0m                             [1m[91m^^^^^^^^^^[0m [1m[91mnot found in `rand`[0m

[1m[91merror[E0425][0m[1m: cannot find function `thread_rng` in crate `rand`[0m
   [1m[94m--> [0msrc/gameplay/table_de_conversion.rs:285:29
    [1m[94m|[0m
[1m[94m285[0m [1m[94m|[0m         let mut rng = rand::thread_rng();
    [1m[94m|[0m                             [1m[91m^^^^^^^^^^[0m [1m[91mnot found in `rand`[0m

[1m[91merror[E0425][0m[1m: cannot find function `thread_rng` in crate `rand`[0m
   [1m[94m--> [0msrc/gameplay/table_de_conversion.rs:368:29
    [1m[94m|[0m
[1m[94m368[0m [1m[94m|[0m         let mut rng = rand::thread_rng();
    [1m[94m|[0m                             [1m[91m^^^^^^^^^^[0m [1m[91mnot found in `rand`[0m

[1m[91merror[E0425][0m[1m: cannot find function `thread_rng` in crate `rand`[0m
   [1m[94m--> [0msrc/gameplay/table_de_conversion.rs:453:29
    [1m[94m|[0m
[1m[94m453[0m [1m[94m|[0m         let mut rng = rand::thread_rng();
    [1m[94m|[0m                             [1m[91m^^^^^^^^^^[0m [1m[91mnot found in `rand`[0m

[1m[91merror[E0425][0m[1m: cannot find function `thread_rng` in crate `rand`[0m
   [1m[94m--> [0msrc/gameplay/table_de_conversion.rs:544:29
    [1m[94m|[0m
[1m[94m544[0m [1m[94m|[0m         let mut rng = rand::thread_rng();
    [1m[94m|[0m                             [1m[91m^^^^^^^^^^[0m [1m[91mnot found in `rand`[0m
...
[1m[91merror[E0382][0m[1m: borrow of moved value: `niveau_7`[0m
   [1m[94m--> [0msrc/gameplay/tresor.rs:280:13
    [1m[94m|[0m
[1m[94m260[0m [1m[94m|[0m         let mut niveau_7 = HashMap::new();
    [1m[94m|[0m             [1m[94m------------[0m [1m[94mmove occurs because `niveau_7` has type `HashMap<std::string::String, u32>`, which does not implement the `Copy` trait[0m
[1m[94m...[0m
[1m[94m271[0m [1m[94m|[0m         objets_garantis.insert(7, niveau_7);
    [1m[94m|[0m                                   [1m[94m--------[0m [1m[94mvalue moved here[0m
[1m[94m...[0m
[1m[94m280[0m [1m[94m|[0m             niveau_7.insert("gemmes".to_string(), 1);
...
[1m[96mhelp[0m: consider cloning the value if the performance cost is acceptable
    [1m[94m|[0m
[1m[94m271[0m [1m[94m| [0m        objets_garantis.insert(7, niveau_7[92m.clone()[0m);
    [1m[94m|[0m                                           [92m++++++++[0m

[1mSome errors have detailed explanations: E0382, E0425, E0432.[0m
[1mFor more information about an error, try `rustc --explain E0382`.[0m
[1m[33mwarning[0m: `the-last-signal-server` (lib) generated 2 warnings
[1m[91merror[0m: could not compile `the-last-signal-server` (lib) due to 7 previous errors; 2 warnings emitted
