...
OS : macos-latest
Branch : main
Commit : 5780803c40b62ffc49424e829909a2e796a33300
Date : Thu Sep 24 00:31:54 UTC 2026
...
[1m[92m  Downloaded[0m zerofrom-derive v0.1.8
...
[1m[92m  Downloaded[0m syn v3.0.6
...
[1m[92m  Downloaded[0m smallvec v1.16.1
...
[1m[92m  Downloaded[0m uuid v1.26.1
...
[1m[92m  Downloaded[0m crc32fast v1.5.2
...
[1m[92m  Downloaded[0m bitflags v2.13.2
...
[1m[92m   Compiling[0m unicode-ident v1.0.26
...
[1m[92m   Compiling[0m syn v3.0.6
[1m[92m   Compiling[0m stable_deref_trait v1.2.1
[1m[92m   Compiling[0m find-msvc-tools v0.1.13
[1m[92m   Compiling[0m shlex v2.0.1
[1m[92m   Compiling[0m cc v1.4.7
...
[1m[92m   Compiling[0m synstructure v0.14.0
...
[1m[92m   Compiling[0m zerofrom-derive v0.1.8
[1m[92m   Compiling[0m yoke-derive v0.8.3
...
[1m[92m   Compiling[0m uuid v1.26.1
...
[1m[92m   Compiling[0m cpufeatures v0.3.1
...
[1m[33mwarning[0m[1m: unused imports: `debug`, `error`, and `info`[0m
 [1m[94m--> [0msrc/gameplay/stuff_manager.rs:4:11
  [1m[94m|[0m
[1m[94m4[0m [1m[94m|[0m use log::{debug, error, info};
  [1m[94m|[0m           [1m[33m^^^^^[0m  [1m[33m^^^^^[0m  [1m[33m^^^^[0m
  [1m[94m|[0m
  [1m[94m= [0m[1mnote[0m: `#[warn(unused_imports)]` (part of `#[warn(unused)]`) on by default

[1m[91merror[E0053][0m[1m: method `retirer` has an incompatible type for trait[0m
   [1m[94m--> [0msrc/gameplay/objets.rs:150:32
    [1m[94m|[0m
[1m[94m150[0m [1m[94m|[0m     fn retirer(&mut self, qte: u128) {
    [1m[94m|[0m                                [1m[91m^^^^[0m [1m[91mexpected `u64`, found `u128`[0m
    [1m[94m|[0m
[1m[92mnote[0m: type in trait
   [1m[94m--> [0msrc/gameplay/objets.rs:22:32
    [1m[94m|[0m
[1m[94m 22[0m [1m[94m|[0m     fn retirer(&mut self, qte: u64);
    [1m[94m|[0m                                [1m[92m^^^[0m
    [1m[94m= [0m[1mnote[0m: expected signature `fn(&mut Equipement, [1m[35mu64[0m)`
               found signature `fn(&mut Equipement, [1m[35mu128[0m)`
[1m[96mhelp[0m: change the parameter type to match the trait
    [1m[94m|[0m
[1m[94m150[0m [91m- [0m    fn retirer(&mut self, qte: [91mu128[0m) {
[1m[94m150[0m [92m+ [0m    fn retirer(&mut self, qte: [92mu64[0m) {
    [1m[94m|[0m

[1m[91merror[E0609][0m[1m: no field `quantite` on type `&Equipement`[0m
   [1m[94m--> [0msrc/gameplay/stuff_manager.rs:222:45
    [1m[94m|[0m
[1m[94m222[0m [1m[94m|[0m         ObjetInventaire::Equipement(o) => o.quantite,
    [1m[94m|[0m                                             [1m[91m^^^^^^^^[0m [1m[91munknown field[0m
    [1m[94m|[0m
[1m[96mhelp[0m: one of the expressions' fields has a field of the same name
    [1m[94m|[0m
[1m[94m222[0m [1m[94m| [0m        ObjetInventaire::Equipement(o) => o.[92mobjet.[0mquantite,
    [1m[94m|[0m                                             [92m++++++[0m

[1m[91merror[E0609][0m[1m: no field `quantite` on type `&Arme`[0m
   [1m[94m--> [0msrc/gameplay/stuff_manager.rs:223:39
    [1m[94m|[0m
[1m[94m223[0m [1m[94m|[0m         ObjetInventaire::Arme(o) => o.quantite,
    [1m[94m|[0m                                       [1m[91m^^^^^^^^[0m [1m[91munknown field[0m
    [1m[94m|[0m
[1m[96mhelp[0m: one of the expressions' fields has a field of the same name
    [1m[94m|[0m
[1m[94m223[0m [1m[94m| [0m        ObjetInventaire::Arme(o) => o.[92mequipement.objet.[0mquantite,
    [1m[94m|[0m                                       [92m+++++++++++++++++[0m

[1m[91merror[E0609][0m[1m: no field `quantite` on type `&Potion`[0m
   [1m[94m--> [0msrc/gameplay/stuff_manager.rs:224:41
    [1m[94m|[0m
[1m[94m224[0m [1m[94m|[0m         ObjetInventaire::Potion(o) => o.quantite,
    [1m[94m|[0m                                         [1m[91m^^^^^^^^[0m [1m[91munknown field[0m
    [1m[94m|[0m
[1m[96mhelp[0m: one of the expressions' fields has a field of the same name
    [1m[94m|[0m
[1m[94m224[0m [1m[94m| [0m        ObjetInventaire::Potion(o) => o.[92mobjet.[0mquantite,
    [1m[94m|[0m                                         [92m++++++[0m

[1m[91merror[E0609][0m[1m: no field `quantite` on type `&Livre`[0m
   [1m[94m--> [0msrc/gameplay/stuff_manager.rs:225:40
    [1m[94m|[0m
[1m[94m225[0m [1m[94m|[0m         ObjetInventaire::Livre(o) => o.quantite,
    [1m[94m|[0m                                        [1m[91m^^^^^^^^[0m [1m[91munknown field[0m
    [1m[94m|[0m
[1m[96mhelp[0m: one of the expressions' fields has a field of the same name
    [1m[94m|[0m
[1m[94m225[0m [1m[94m| [0m        ObjetInventaire::Livre(o) => o.[92mobjet.[0mquantite,
    [1m[94m|[0m                                        [92m++++++[0m

[1m[91merror[E0277][0m[1m: the trait bound `u64: sqlx::Encode<'_, Sqlite>` is not satisfied[0m
   [1m[94m--> [0msrc/gameplay/stuff_manager.rs:276:15
    [1m[94m|[0m
[1m[94m276[0m [1m[94m|[0m         .bind(quantite)
    [1m[94m|[0m          [1m[94m----[0m [1m[91m^^^^^^^^[0m [1m[91mthe trait `sqlx::Encode<'_, Sqlite>` is not implemented for `u64`[0m
    [1m[94m|[0m          [1m[94m|[0m
    ...
    [1m[94m= [0m[1mhelp[0m: the following other types implement trait `sqlx::Encode<'q, DB>`:
            ...
            and 6 others
[1m[92mnote[0m: required by a bound in `Query::<'_, DB, <DB as sqlx::Database>::Arguments>::bind`
   [1m[94m--> [0m/Users/runner/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/sqlx-core-0.9.0/src/query.rs:87:24
    [1m[94m|[0m
[1m[94m 87[0m [1m[94m|[0m     pub fn bind<'t, T: Encode<'t, DB> + Type<DB>>(mut self, value: T) -> Self {
    [1m[94m|[0m                        [1m[92m^^^^^^^^^^^^^^[0m [1m[92mrequired by this bound in `Query::<'_, DB, <DB as Database>::Arguments>::bind`[0m

[1m[91merror[E0277][0m[1m: the trait bound `u64: sqlx::Encode<'_, Sqlite>` is not satisfied[0m
   [1m[94m--> [0msrc/gameplay/stuff_manager.rs:302:15
    [1m[94m|[0m
[1m[94m302[0m [1m[94m|[0m         .bind(quantite)
    [1m[94m|[0m          [1m[94m----[0m [1m[91m^^^^^^^^[0m [1m[91mthe trait `sqlx::Encode<'_, Sqlite>` is not implemented for `u64`[0m
    [1m[94m|[0m          [1m[94m|[0m
    [1m[94m|[0m          [1m[94mrequired by a bound introduced by this call[0m
    [1m[94m|[0m
...
[1m[91merror[E0277][0m[1m: the trait bound `u64: sqlx::Encode<'_, Sqlite>` is not satisfied[0m
   [1m[94m--> [0msrc/gameplay/stuff_manager.rs:305:15
    [1m[94m|[0m
[1m[94m305[0m [1m[94m|[0m         .bind(quantite)
    [1m[94m|[0m          [1m[94m----[0m [1m[91m^^^^^^^^[0m [1m[91mthe trait `sqlx::Encode<'_, Sqlite>` is not implemented for `u64`[0m
    [1m[94m|[0m          [1m[94m|[0m
    [1m[94m|[0m          [1m[94mrequired by a bound introduced by this call[0m
    [1m[94m|[0m
...
[1m[91merror[E0277][0m[1m: the trait bound `u64: sqlx::Encode<'_, Sqlite>` is not satisfied[0m
   [1m[94m--> [0msrc/gameplay/stuff_manager.rs:383:11
    [1m[94m|[0m
[1m[94m383[0m [1m[94m|[0m     .bind(quantite)
    [1m[94m|[0m      [1m[94m----[0m [1m[91m^^^^^^^^[0m [1m[91mthe trait `sqlx::Encode<'_, Sqlite>` is not implemented for `u64`[0m
    [1m[94m|[0m      [1m[94m|[0m
    [1m[94m|[0m      [1m[94mrequired by a bound introduced by this call[0m
    [1m[94m|[0m
...
[1m[91merror[E0308][0m[1m: mismatched types[0m
   [1m[94m--> [0msrc/gameplay/objets.rs:151:28
    [1m[94m|[0m
[1m[94m151[0m [1m[94m|[0m         self.objet.retirer(qte);
    [1m[94m|[0m                    [1m[94m-------[0m [1m[91m^^^[0m [1m[91mexpected `u64`, found `u128`[0m
    [1m[94m|[0m                    [1m[94m|[0m
    [1m[94m|[0m                    [1m[94marguments to this method are incorrect[0m
    [1m[94m|[0m
[1m[92mnote[0m: method defined here
   [1m[94m--> [0msrc/gameplay/objets.rs:22:8
    [1m[94m|[0m
[1m[94m 22[0m [1m[94m|[0m     fn retirer(&mut self, qte: u64);
    [1m[94m|[0m        [1m[92m^^^^^^^[0m            [1m[94m---[0m
[1m[96mhelp[0m: you can convert a `u128` to a `u64` and panic if the converted value doesn't fit
    [1m[94m|[0m
[1m[94m151[0m [1m[94m| [0m        self.objet.retirer(qte[92m.try_into().unwrap()[0m);
    [1m[94m|[0m                               [92m++++++++++++++++++++[0m

[1mSome errors have detailed explanations: E0053, E0277, E0308, E0609.[0m
[1mFor more information about an error, try `rustc --explain E0053`.[0m
[1m[33mwarning[0m: `the-last-signal-server` (lib) generated 1 warning
[1m[91merror[0m: could not compile `the-last-signal-server` (lib) due to 10 previous errors; 1 warning emitted
