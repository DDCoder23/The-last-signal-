...
Date : Thu Sep 10 15:34:00 UTC 2026
...
[1m[91merror[E0432][0m[1m: unresolved import `crate::objets`[0m
 [1m[94m--> [0msrc/gameplay/stuff_manager.rs:6:12
  [1m[94m|[0m
[1m[94m6[0m [1m[94m|[0m use crate::objets::{Objet, TypeObjet, NomAffiche, AjouterRetirer, Equipement, Arme, Potion, Livre};
  [1m[94m|[0m            [1m[91m^^^^^^[0m [1m[91munresolved import[0m
  [1m[94m|[0m
[1m[96mhelp[0m: a similar path exists
  [1m[94m|[0m
[1m[94m6[0m [1m[94m| [0muse crate::[92mgameplay::[0mobjets::{Objet, TypeObjet, NomAffiche, AjouterRetirer, Equipement, Arme, Potion, Livre};
  [1m[94m|[0m            [92m++++++++++[0m
