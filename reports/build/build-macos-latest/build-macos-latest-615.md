...
Date : Fri Aug 21 22:19:01 UTC 2026
...
[1m[92m  Downloaded[0m uuid v1.24.1
...
[1m[91merror[0m[1m: expected `;`, found `{`[0m
   [1m[94m--> [0msrc/network/handler.rs:330:7
    [1m[94m|[0m
[1m[94m330[0m [1m[94m|[0m .await
    [1m[94m|[0m       [1m[91m^[0m [1m[91mhelp: add `;` here[0m
[1m[94m331[0m [1m[94m|[0m {
    [1m[94m|[0m [1m[94m-[0m [1m[94munexpected token[0m

[1m[91merror[0m[1m: expected one of `.`, `;`, `?`, `}`, or an operator, found `=>`[0m
   [1m[94m--> [0msrc/network/handler.rs:332:16
    [1m[94m|[0m
[1m[94m332[0m [1m[94m|[0m     Ok(result) => result.rows_affected() > 0,
    [1m[94m|[0m                [1m[91m^^[0m [1m[91mexpected one of `.`, `;`, `?`, `}`, or an operator[0m

[1m[91merror[0m[1m: set `DATABASE_URL` to use query macros online, or run `cargo sqlx prepare` to update the query cache[0m
   [1m[94m--> [0msrc/network/handler.rs:407:15
    [1m[94m|[0m
[1m[94m407[0m [1m[94m|[0m           match sqlx::query_scalar!(
    [1m[94m|[0m [1m[91m _______________^[0m
[1m[94m408[0m [1m[94m|[0m [1m[91m|[0m             r#"
[1m[94m409[0m [1m[94m|[0m [1m[91m|[0m             SELECT EXISTS(
[1m[94m410[0m [1m[94m|[0m [1m[91m|[0m                 SELECT 1
[1m[94m...[0m   [1m[91m|[0m
[1m[94m415[0m [1m[94m|[0m [1m[91m|[0m             "#,)
    [1m[94m|[0m [1m[91m|________________^[0m
    [1m[94m|[0m
    [1m[94m= [0m[1mnote[0m: this error originates in the macro `$crate::sqlx_macros::expand_query` which comes from the expansion of the macro `sqlx::query_scalar` (in Nightly builds, run with -Z macro-backtrace for more info)

[1m[91merror[0m[1m: set `DATABASE_URL` to use query macros online, or run `cargo sqlx prepare` to update the query cache[0m
   [1m[94m--> [0msrc/network/handler.rs:580:33
    [1m[94m|[0m
[1m[94m580[0m [1m[94m|[0m               if let Err(error) = sqlx::query!(
    [1m[94m|[0m [1m[91m _________________________________^[0m
[1m[94m581[0m [1m[94m|[0m [1m[91m|[0m                 r#"
[1m[94m582[0m [1m[94m|[0m [1m[91m|[0m                 DELETE FROM login_attempts
[1m[94m583[0m [1m[94m|[0m [1m[91m|[0m                 WHERE user_id = ?
[1m[94m584[0m [1m[94m|[0m [1m[91m|[0m                 "#,
[1m[94m585[0m [1m[94m|[0m [1m[91m|[0m                 user.user_id
[1m[94m586[0m [1m[94m|[0m [1m[91m|[0m             )
...
[1m[91merror[E0308][0m[1m: mismatched types[0m
  [1m[94m--> [0msrc/database/migrations.rs:50:9
   [1m[94m|[0m
[1m[94m44[0m [1m[94m|[0m     create_account(
   [1m[94m|[0m     [1m[94m--------------[0m [1m[94marguments to this function are incorrect[0m
[1m[94m...[0m
[1m[94m50[0m [1m[94m|[0m         "DISCONNECTED",
   [1m[94m|[0m         [1m[91m^^^^^^^^^^^^^^[0m [1m[91mexpected `Option<&str>`, found `&str`[0m
   [1m[94m|[0m
   [1m[94m= [0m[1mnote[0m:   expected enum `[1m[35mstd::option::Option<&str>[0m`
           found reference `[1m[35m&'static [0m[1m[35mstr[0m`
[1m[92mnote[0m: function defined here
  [1m[94m--> [0msrc/utils/account_creator.rs:3:14
   [1m[94m|[0m
[1m[94m 3[0m [1m[94m|[0m pub async fn create_account(
   [1m[94m|[0m              [1m[92m^^^^^^^^^^^^^^[0m
[1m[94m...[0m
[1m[94m 9[0m [1m[94m|[0m     status: Option<&str>,
   [1m[94m|[0m     [1m[94m--------------------[0m
[1m[96mhelp[0m: try wrapping the expression in `Some`
   [1m[94m|[0m
[1m[94m50[0m [1m[94m| [0m        [92mSome([0m"DISCONNECTED"[92m)[0m,
   [1m[94m|[0m         [92m+++++[0m              [92m+[0m

[1m[91merror[E0308][0m[1m: mismatched types[0m
  [1m[94m--> [0msrc/database/migrations.rs:60:5
   [1m[94m|[0m
[1m[94m54[0m [1m[94m|[0m create_account(
   [1m[94m|[0m [1m[94m--------------[0m [1m[94marguments to this function are incorrect[0m
[1m[94m...[0m
[1m[94m60[0m [1m[94m|[0m     "DISCONNECTED",
   [1m[94m|[0m     [1m[91m^^^^^^^^^^^^^^[0m [1m[91mexpected `Option<&str>`, found `&str`[0m
   [1m[94m|[0m
   [1m[94m= [0m[1mnote[0m:   expected enum `[1m[35mstd::option::Option<&str>[0m`
           found reference `[1m[35m&'static [0m[1m[35mstr[0m`
...
[1m[96mhelp[0m: try wrapping the expression in `Some`
   [1m[94m|[0m
[1m[94m60[0m [1m[94m| [0m    [92mSome([0m"DISCONNECTED"[92m)[0m,
   [1m[94m|[0m     [92m+++++[0m              [92m+[0m

[1m[91merror[E0609][0m[1m: no field `user_id` on type `SqliteRow`[0m
   [1m[94m--> [0msrc/network/handler.rs:328:12
    [1m[94m|[0m
[1m[94m328[0m [1m[94m|[0m .bind(user.user_id)
    [1m[94m|[0m            [1m[91m^^^^^^^[0m [1m[91munknown field[0m

[1m[91merror[E0600][0m[1m: cannot apply unary operator `!` to type `Result<SqliteQueryResult, sqlx::Error>`[0m
   [1m[94m--> [0msrc/network/handler.rs:347:4
    [1m[94m|[0m
[1m[94m347[0m [1m[94m|[0m if !connected {
    [1m[94m|[0m    [1m[91m^^^^^^^^^^[0m [1m[91mcannot apply unary operator `!`[0m
    [1m[94m|[0m
[1m[92mnote[0m: `Result<SqliteQueryResult, sqlx::Error>` does not implement `Not`
   [1m[94m--> [0m/rustc/88d9e12ae178fab0fb5cc050a94da85685d449ea/library/core/src/result.rs:557:0
    [1m[94m|[0m
    [1m[94m= [0m[1mnote[0m: `Result<SqliteQueryResult, sqlx::Error>` is defined in another crate

[1m[91merror[E0609][0m[1m: no field `user_id` on type `SqliteRow`[0m
   [1m[94m--> [0msrc/network/handler.rs:368:24
    [1m[94m|[0m
[1m[94m368[0m [1m[94m|[0m             .bind(user.user_id)
    [1m[94m|[0m                        [1m[91m^^^^^^^[0m [1m[91munknown field[0m

[1m[91merror[E0609][0m[1m: no field `user_id` on type `SqliteRow`[0m
   [1m[94m--> [0msrc/network/handler.rs:416:24
    [1m[94m|[0m
[1m[94m416[0m [1m[94m|[0m             .bind(user.user_id)
    [1m[94m|[0m                        [1m[91m^^^^^^^[0m [1m[91munknown field[0m

[1m[91merror[E0609][0m[1m: no field `password_hash` on type `SqliteRow`[0m
   [1m[94m--> [0msrc/network/handler.rs:456:15
    [1m[94m|[0m
[1m[94m456[0m [1m[94m|[0m         &user.password_hash,
    [1m[94m|[0m               [1m[91m^^^^^^^^^^^^^[0m [1m[91munknown field[0m

[1m[91merror[E0609][0m[1m: no field `user_id` on type `SqliteRow`[0m
   [1m[94m--> [0msrc/network/handler.rs:489:24
    [1m[94m|[0m
[1m[94m489[0m [1m[94m|[0m             .bind(user.user_id)
    [1m[94m|[0m                        [1m[91m^^^^^^^[0m [1m[91munknown field[0m

[1m[91merror[E0609][0m[1m: no field `user_id` on type `SqliteRow`[0m
   [1m[94m--> [0msrc/network/handler.rs:559:28
    [1m[94m|[0m
[1m[94m559[0m [1m[94m|[0m                 .bind(user.user_id
    [1m[94m|[0m                            [1m[91m^^^^^^^[0m [1m[91munknown field[0m

[1m[91merror[E0609][0m[1m: no field `user_id` on type `SqliteRow`[0m
   [1m[94m--> [0msrc/network/handler.rs:631:20
    [1m[94m|[0m
[1m[94m631[0m [1m[94m|[0m         .bind(user.user_id
    [1m[94m|[0m                    [1m[91m^^^^^^^[0m [1m[91munknown field[0m

[1m[91merror[E0277][0m[1m: the trait bound `&&Pool<Sqlite>: Executor<'_>` is not satisfied[0m
   [1m[94m--> [0msrc/utils/account_creator.rs:99:18
    [1m[94m|[0m
[1m[94m 99[0m [1m[94m|[0m         .execute(&pool)
    [1m[94m|[0m          [1m[94m-------[0m [1m[91m^^^^^[0m [1m[91mthe trait `Executor<'_>` is not implemented for `&&Pool<Sqlite>`[0m
    [1m[94m|[0m          [1m[94m|[0m
    [1m[94m|[0m          [1m[94mrequired by a bound introduced by this call[0m
    [1m[94m|[0m
[1m[92mnote[0m: required by a bound in `Query::<'q, DB, A>::execute`
   [1m[94m--> [0m/Users/runner/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/sqlx-core-0.9.0/src/query.rs:189:12
    [1m[94m|[0m
[1m[94m185[0m [1m[94m|[0m     pub async fn execute<'e, 'c: 'e, E>(self, executor: E) -> Result<DB::QueryResult, Error>
    [1m[94m|[0m                  [1m[94m-------[0m [1m[94mrequired by a bound in this associated function[0m
[1m[94m...[0m
[1m[94m189[0m [1m[94m|[0m         E: Executor<'c, Database = DB>,
    [1m[94m|[0m            [1m[92m^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m [1m[92mrequired by this bound in `Query::<'q, DB, A>::execute`[0m
[1m[96mhelp[0m: consider dereferencing here
    [1m[94m|[0m
[1m[94m 99[0m [1m[94m| [0m        .execute(&[92m*[0mpool)
    [1m[94m|[0m                   [92m+[0m
[1m[96mhelp[0m: consider removing the leading `&`-reference
    [1m[94m|[0m
[1m[94m 99[0m [91m- [0m        .execute([91m&[0mpool)
[1m[94m 99[0m [92m+ [0m        .execute(pool)
    [1m[94m|[0m

[1m[91merror[E0277][0m[1m: the trait bound `&&Pool<Sqlite>: Executor<'_>` is not satisfied[0m
   [1m[94m--> [0msrc/utils/account_creator.rs:90:9
    [1m[94m|[0m
[1m[94m 90[0m [1m[94m|[0m [1m[91m/[0m         sqlx::query(
[1m[94m 91[0m [1m[94m|[0m [1m[91m|[0m             r#"
[1m[94m 92[0m [1m[94m|[0m [1m[91m|[0m             UPDATE users
[1m[94m 93[0m [1m[94m|[0m [1m[91m|[0m             SET status = ?
[1m[94m...[0m   [1m[91m|[0m
[1m[94m 98[0m [1m[94m|[0m [1m[91m|[0m         .bind(&email)
[1m[94m 99[0m [1m[94m|[0m [1m[91m|[0m         .execute(&pool)
    [1m[94m|[0m [1m[91m|_______________________^[0m [1m[91mthe trait `Executor<'_>` is not implemented for `&&Pool<Sqlite>`[0m
    [1m[94m|[0m
[1m[96mhelp[0m: the trait `Executor<'_>` [1m[35mis not[0m implemented for `&[1m[35m&[0mPool<[1m[35mSqlite[0m>`
      but it [1m[35mis[0m implemented for `&Pool<[1m[35m_[0m>`
   [1m[94m--> [0m/Users/runner/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/sqlx-core-0.9.0/src/pool/executor.rs:12:1
    [1m[94m|[0m
[1m[94m 12[0m [1m[94m|[0m [1m[96m/[0m impl<'p, DB: Database> Executor<'p> for &'_ Pool<DB>
[1m[94m 13[0m [1m[94m|[0m [1m[96m|[0m where
[1m[94m 14[0m [1m[94m|[0m [1m[96m|[0m     for<'c> &'c mut DB::Connection: Executor<'c, Database = DB>,
    [1m[94m|[0m [1m[96m|________________________________________________________________^[0m
    [1m[94m= [0m[1mhelp[0m: for that trait implementation, expected `[1m[35mPool<_>[0m`, found `[1m[35m&Pool<Sqlite>[0m`
[1m[92mnote[0m: required by a bound in `Query::<'q, DB, A>::execute`
   [1m[94m--> [0m/Users/runner/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/sqlx-core-0.9.0/src/query.rs:189:12
    [1m[94m|[0m
[1m[94m185[0m [1m[94m|[0m     pub async fn execute<'e, 'c: 'e, E>(self, executor: E) -> Result<DB::QueryResult, Error>
...
[1m[91merror[E0277][0m[1m: the trait bound `&&Pool<Sqlite>: Executor<'_>` is not satisfied[0m
   [1m[94m--> [0msrc/utils/account_creator.rs:100:10
    [1m[94m|[0m
[1m[94m100[0m [1m[94m|[0m         .await?;
    [1m[94m|[0m          [1m[91m^^^^^[0m [1m[91mthe trait `Executor<'_>` is not implemented for `&&Pool<Sqlite>`[0m
    [1m[94m|[0m
[1m[96mhelp[0m: the trait `Executor<'_>` [1m[35mis not[0m implemented for `&[1m[35m&[0mPool<[1m[35mSqlite[0m>`
      but it [1m[35mis[0m implemented for `&Pool<[1m[35m_[0m>`
   [1m[94m--> [0m/Users/runner/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/sqlx-core-0.9.0/src/pool/executor.rs:12:1
...
[1mSome errors have detailed explanations: E0277, E0308, E0600, E0609.[0m
...
[1m[91merror[0m: could not compile `the-last-signal-server` (lib) due to 17 previous errors; 4 warnings emitted
