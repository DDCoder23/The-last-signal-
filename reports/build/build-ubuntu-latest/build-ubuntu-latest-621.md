...
Date : Tue Aug 25 07:39:01 UTC 2026
...
Compiling 'tests/security/attack_test.py'...
Compiling 'tests/security/integrity_check.py'...
...
[1m[92m   Compiling[0m syn v3.0.4
...
[1m[33mwarning[0m[1m: fields `user_id` and `password_hash` are never read[0m
  [1m[94m--> [0msrc/network/handler.rs:16:5
   [1m[94m|[0m
[1m[94m15[0m [1m[94m|[0m pub struct User {
   [1m[94m|[0m            [1m[94m----[0m [1m[94mfields in this struct[0m
[1m[94m16[0m [1m[94m|[0m     user_id: String,
   [1m[94m|[0m     [1m[33m^^^^^^^[0m
[1m[94m17[0m [1m[94m|[0m     password_hash: String,
   [1m[94m|[0m     [1m[33m^^^^^^^^^^^^^[0m
   [1m[94m|[0m
...
[1m[33mwarning[0m: `the-last-signal-server` (lib) generated 7 warnings (run `cargo fix --lib -p the-last-signal-server` to apply 4 suggestions)
...
[1m[92m    Finished[0m `release` profile [optimized] target(s) in 2m 08s
