...
OS : ubuntu-latest
Branch : main
Commit : 51ddb4bc1aede26b49802327fdc7bbeee6cf7437
Date : Tue Aug 18 22:17:37 UTC 2026
...
[1m[92m     Locking[0m 237 packages to latest Rust 1.97.1 compatible versions
...
[1m[92m  Downloaded[0m zerovec-derive v0.11.5
...
[1m[92m  Downloaded[0m icu_provider v2.3.0
...
[1m[92m  Downloaded[0m zerovec v0.11.7
...
[1m[92m   Compiling[0m zerovec-derive v0.11.5
...
[1m[92m   Compiling[0m zerovec v0.11.7
...
[1m[92m   Compiling[0m icu_provider v2.3.0
...
[1m[92m   Compiling[0m aes-gcm v0.11.0
...
[1m[33mwarning[0m[1m: constant `PO` is never used[0m
 [1m[94m--> [0msrc/gameplay/tresor.rs:9:7
  [1m[94m|[0m
[1m[94m9[0m [1m[94m|[0m const PO: u32 = PA * 10;
  [1m[94m|[0m       [1m[33m^^[0m

[1m[33mwarning[0m[1m: constant `PP` is never used[0m
  [1m[94m--> [0msrc/gameplay/tresor.rs:10:7
   [1m[94m|[0m
[1m[94m10[0m [1m[94m|[0m const PP: u32 = PO * 10;
   [1m[94m|[0m       [1m[33m^^[0m

[1m[33mwarning[0m: `the-last-signal-server` (lib) generated 6 warnings (run `cargo fix --lib -p the-last-signal-server` to apply 3 suggestions)
...
[1m[33mwarning[0m[1m: unused import: `debug`[0m
 [1m[94m--> [0msrc/main.rs:6:11
  [1m[94m|[0m
[1m[94m6[0m [1m[94m|[0m use log::{debug,info};
  [1m[94m|[0m           [1m[33m^^^^^[0m
