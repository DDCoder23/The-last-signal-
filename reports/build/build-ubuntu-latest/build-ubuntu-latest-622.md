...
Date : Tue Aug 25 23:27:19 UTC 2026
...
[1m[92m     Locking[0m 194 packages to latest Rust 1.98.0 compatible versions
...
[1m[33mwarning[0m[1m: unused import: `debug`[0m
 [1m[94m--> [0msrc/main.rs:5:11
  [1m[94m|[0m
[1m[94m5[0m [1m[94m|[0m use log::{debug,info};
  [1m[94m|[0m           [1m[33m^^^^^[0m
  [1m[94m|[0m
  [1m[94m= [0m[1mnote[0m: `#[warn(unused_imports)]` (part of `#[warn(unused)]`) on by default
...
[1m[92m    Finished[0m `release` profile [optimized] target(s) in 2m 01s
