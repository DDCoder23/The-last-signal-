...
- **Message :** Traceback (most recent call last):
  File "/home/runner/work/The-last-signal-/The-last-signal-/scripts/documentation/score.py", line 30, in generate_score
    result = check()
  File "/home/runner/work/The-last-signal-/The-last-signal-/scripts/documentation/titles.py", line 35, in check_titles
    results["single_h1"] = check_single_h1(files, problems)
                           ~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^
  File "/home/runner/work/The-last-signal-/The-last-signal-/scripts/documentation/titles.py", line 59, in check_single_h1
    add_problem (file,"error",f"{file}: contient {h1} titres H1 (1 attendu).")
    ~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
TypeError: add_problem() missing 1 required positional argument: 'message'
